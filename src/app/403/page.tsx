    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          ...
          <h1 className="mt-6 text-3xl font-bold text-gray-900 dark:text-white">403</h1>
          <h2 className="mt-2 text-xl font-semibold text-gray-900 dark:text-white">Access Denied</h2>
